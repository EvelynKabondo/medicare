...
export default function WelcomePage() {
  return (
    <div
      className="flex min-h-screen items-center flex-col bg-cover bg-center"
    ...
    >
      ...
      <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl drop-shadow-lg">Doctor's Appointment System</h1>
      <p className="mt-4 text-lg text-blue-400 drop-shadow-lg">
